<?php 
	...
	$navRightButtonName = 'New Category';
	$params = array();
...
?>
	<script type="text/javascript" charset="utf-8">	
		function pageInit(){
			...
			LBN_TABLE.init('lbn_category.title','<?php p(join('&',$tableParams)); ?>');			
		}
	</script>	
<style>
	.modal-file{margin : -300px 0 0 -460px;width:920px;}
	.modal-file .modal-body{max-height: 500px;}
</style>     
