...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', $_SERVER['DOCUMENT_ROOT'].ABSOLUTE_UPLOAD_PATH.'types/no-found.jpg');	// Image to serve if any 404 occurs 
...
if(! defined('DEFAULT_CC') )			define ('DEFAULT_CC', 'f1f1f1');							// Default canvas colour. Allows overrid in timthumb-config.php
...
class timthumb {
	...
	protected function processImageAndWriteToCache($localImage){
		...
		$avatar = (int) abs ($this->param('av', 0));
		$full = (int) abs ($this->param('full', 0));
	...
	protected function getLocalImagePath($src){
		$src = ABSOLUTE_UPLOAD_PATH.ltrim($src, '/'); //strip off the leading '/'
		//echo $src;
		if(! $this->docRoot){
