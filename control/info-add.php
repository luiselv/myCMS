<?php  
	...
	Lbn::addInput($inputItems,'Picture|upload|required span4|||0|root_file');
	Lbn::addInput($inputItems,'Picture Title|text|span8|||0|picturetitle');
                ...
                $(document).ready(function(){
    				$('#tab-media').click(function(event){
    					...
    					if(actionX == "Save"){
    						...
    						alert("Please complete and save the information first.");
    					}
    				});							
    			});
            }	
